...
//    }
        ...
        val view = infalter.inflate(R.layout.fragment_book,container,false)
        val rvbook:RecyclerView = view.findViewById(R.id.recycle_book)
        ...
        rvbook.layoutManager = LinearLayoutManager(activity)
            rvbook.adapter = BookAdapter(listData)

        val buttonAdd : Button = view.findViewById(R.id.AddBook)
